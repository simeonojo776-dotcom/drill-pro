...
const UserProfile = ({ 
  ...
  totalExamsTaken, isPremium // 👈 Catch the new props here
}) => {
    ...
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px', color: '#f8fafc', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gap: '20px' }}>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: '12px', padding: '25px' }}>
          ...
          <button onClick={handleSaveProfile} disabled={isSavingProfile} style={{ marginTop: '20px', background: '#38bdf8', color: '#000', border: 'none', padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', cursor: isSavingProfile ? 'wait' : 'pointer', transition: 'all 0.2s' }}>
