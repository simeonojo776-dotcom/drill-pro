...
const CommandCenter = ({
  ...
  return (
    <div style={{ width: '100%', maxWidth: '1000px', margin: '40px auto 100px auto', padding: '0 20px', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px', borderBottom: '1px solid #334155', paddingBottom: '20px' }}>
        <div>
          <h2 style={{ color: '#f8fafc', margin: '0 0 5px 0', fontSize: '1.8rem' }}>Dashboard</h2>
          <p style={{ color: '#94a3b8', margin: 0 }}>Performance overview and schedule.</p>
        </div>
        <button onClick={() => setActiveModule('examSetup')} style={{ padding: '12px 24px', backgroundColor: '#38bdf8', color: '#0f172a', border: 'none', borderRadius: '6px', fontWeight: 'bold', fontSize: '14px', letterSpacing: '1px', cursor: 'pointer', width: '100%', maxWidth: '250px' }}>
          START PRACTICE
        </button>
      </div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px', marginBottom: '30px' }}>
        <div style={{ flex: '1 1 calc(50% - 15px)', minWidth: '140px', backgroundColor: '#0f172a', padding: '20px', borderRadius: '12px', border: '1px solid #1e293b' }}>
          <p style={{ margin: '0 0 10px 0', color: '#94a3b8', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}>Total Questions</p>
        ...
        <div style={{ flex: '1 1 calc(50% - 15px)', minWidth: '140px', backgroundColor: 'rgba(16, 185, 129, 0.1)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(16, 185, 129, 0.3)' }}>
          <p style={{ margin: '0 0 10px 0', color: '#10b981', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}>Total Passed</p>
        ...
        <div style={{ flex: '1 1 calc(50% - 15px)', minWidth: '140px', backgroundColor: 'rgba(239, 68, 68, 0.1)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(239, 68, 68, 0.3)' }}>
          <p style={{ margin: '0 0 10px 0', color: '#ef4444', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}>Total Failed</p>
          <h2 style={{ margin: 0, fontSize: '28px', color: '#ef4444' }}>{liveStats.totalFailed || 0}</h2>
        </div>
        <div style={{ flex: '1 1 calc(50% - 15px)', minWidth: '140px', backgroundColor: '#0f172a', padding: '20px', borderRadius: '12px', border: '1px solid #1e293b' }}>
          <p style={{ margin: '0 0 10px 0', color: '#38bdf8', fontSize: '11px', fontWeight: 'bold', textTransform: 'uppercase' }}>Average Score</p>
      ...
      <div style={{ width: '100%', backgroundColor: '#0f172a', padding: '30px', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '30px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px', marginBottom: '20px' }}>
          <h3 style={{ margin: 0, color: '#f8fafc', fontSize: '18px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Calendar size={20} color="#38bdf8" /> Upcoming Schedule
          </h3>
          <button 
        ...
        {isAddingExam && (
          <div style={{ background: '#020617', padding: '20px', borderRadius: '12px', border: '1px dashed #334155', marginBottom: '20px', display: 'flex', flexWrap: 'wrap', gap: '15px', alignItems: 'flex-end' }}>
             ...
             <button onClick={handleAddExam} style={{ padding: '10px 20px', background: '#10b981', color: '#0f172a', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer', height: '40px' }}>SAVE</button>
          </div>
        )}
             ...
             examSchedule.map(exam => {
                ...
                return (
                  <div key={exam.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#020617', padding: '15px 20px', borderRadius: '8px', borderLeft: `4px solid ${urgencyColor}`, borderRight: '1px solid #1e293b', borderTop: '1px solid #1e293b', borderBottom: '1px solid #1e293b', flexWrap: 'wrap', gap: '15px' }}>
                     <div>
                       <h4 style={{ margin: '0 0 5px 0', color: '#f8fafc', fontSize: '1.1rem' }}>{exam.name}</h4>
